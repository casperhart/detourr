...
TensorFlow (Abadi et al. (2016)) with a variation of the code found in
this example: https://www.tensorflow.org/addons/tutorials/losses_triplet
...
10000 rows and 34 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
10000 rows and 10 columns.
...
Abadi, M, P Barham, J Chen, Z Chen, A Davis, J Dean, M Devin, S
Ghemawat, G Irving, M Isard, et al. (2016). TensorFlow: A System for
