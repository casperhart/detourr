...
test_that("colours work", {
  ...
  t <- detour(tourr::flea, mapping = tour_aes(
    ...
    tour_path(max_bases = 2) |>
    display_scatter(background_colour = "lightgray")
  ...
  t <- detour(tourr::flea, mapping = tour_aes(
    ...
    tour_path(max_bases = 2) |>
    display_scatter(background_color = "lightgray")
